...
#
# Served by FilePromptRepository for getLatest('search-v2', 'claude').
# The v2 prompt uses 5 tools over compendium + dossier repositories,
# with qualified source references in the SOURCES: line.
#
# For the canonical reference copy see: ../search/claude/v2/prompt.md
