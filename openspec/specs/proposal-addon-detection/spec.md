...
Detects capabilities introduced by AI during the explore dialogue that were not in the original issue body and splits them into separate proposal change directories.
## Requirements
